...
#define __CLC_NVVM_ATOMIC_STORE(TYPE, TYPE_MANGLED, TYPE_NV, TYPE_MANGLED_NV)  \
  __CLC_NVVM_ATOMIC_STORE_IMPL(TYPE, TYPE_MANGLED, 1, TYPE_NV,                 \
                               TYPE_MANGLED_NV, __global, PU3AS1, _global_)    \
  __CLC_NVVM_ATOMIC_STORE_IMPL(TYPE, TYPE_MANGLED, 1, TYPE_NV,                 \
                               TYPE_MANGLED_NV, __local, PU3AS3, _shared_)     \
  __CLC_NVVM_ATOMIC_STORE_IMPL(TYPE, TYPE_MANGLED, 0, TYPE_NV,                 \
                               TYPE_MANGLED_NV, , P, _gen_)
