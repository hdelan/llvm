...
#define AMDGPU_ATOMIC_LOAD_IMPL(TYPE, TYPE_MANGLED, AS, AS_MANGLED,                                                        \
                                NOT_GENERIC)                                                                               \
  _CLC_DEF TYPE                                                                                                            \
      _Z18__spirv_AtomicLoadP##AS_MANGLED##TYPE_MANGLED##N5__spv5Scope4FlagENS##NOT_GENERIC##_19MemorySemanticsMask4FlagE( \
...
#define AMDGPU_ATOMIC_LOAD(TYPE, TYPE_MANGLED)                                 \
  AMDGPU_ATOMIC_LOAD_IMPL(TYPE, TYPE_MANGLED, global, U3AS1, 1)                \
  AMDGPU_ATOMIC_LOAD_IMPL(TYPE, TYPE_MANGLED, local, U3AS3, 1)                 \
  AMDGPU_ATOMIC_LOAD_IMPL(TYPE, TYPE_MANGLED, , , 1)
